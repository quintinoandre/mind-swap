...
public final class Messages {
    ...
    public static final String VAMPIRE_BITE = "%s drank some blood and now my current health level is %d.%n";
    public static final String MONSTER_IS_DEAD = "%s is dead!%n";
    public static final String MONSTER_DEFEND = "%s suffered %d points hit. Current health level: %d%n";
    public static final String KILL_FAIRY = "A fairy is too cute to be killed! :)%n";
    public static final String FAIRY_HEALTH = "The fairy health is immutable!%n";
